...
export default function Dashboard() {
  ...
  return <div className="space-y-6 pb-10">
    <section className="panel p-5"><h2 className="text-lg font-semibold text-white">Authorized Freeze/Hold Intelligence</h2><p className="mt-2 text-sm text-slate-400">Prepare verifiable blockchain evidence for authorized intervention.</p><Link href="/freeze-hold" className="mt-3 inline-block text-sm text-cyan-200">Open Intelligence Workflow →</Link></section>
